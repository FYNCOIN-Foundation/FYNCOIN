...
RESOURCES += src/qt/fyn.qrc src/qt/fyn_locale.qrc

TRANSLATIONS += src/qt/locale/fyn_bg.ts \
                src/qt/locale/fyn_de.ts \
                src/qt/locale/fyn_en.ts \
                src/qt/locale/fyn_es.ts \
                src/qt/locale/fyn_fi.ts \
                src/qt/locale/fyn_fr.ts \
                src/qt/locale/fyn_it.ts \
                src/qt/locale/fyn_ja.ts \
                src/qt/locale/fyn_pl.ts \
                src/qt/locale/fyn_pt.ts \
                src/qt/locale/fyn_ru.ts \
                src/qt/locale/fyn_sk.ts \
                src/qt/locale/fyn_sv.ts \
                src/qt/locale/fyn_vi.ts \
                src/qt/locale/fyn_zh_CN.ts \
                src/qt/locale/fyn_zh_TW.ts
