...
This means one can have an always-on fynd instance running, and another local fynd/fyn-qt instance which connects to this node and receives blocks from it.
