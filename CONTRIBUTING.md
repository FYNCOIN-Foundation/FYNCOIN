Contributing to FYN Core
============================

The FYN Core project operates an open contributor model where anyone is
...
The following applies to code changes to the FYN Core project, and is not to be
confused with overall FYN Network Protocol consensus changes.

Whether a pull request is merged into FYN Core rests with the project merge
...
Patches that change FYN consensus rules are considerably more involved than
...
Where a patch set proposes to change the FYN consensus, it must have been
...
The project leader is the release manager for each FYN Core release.
