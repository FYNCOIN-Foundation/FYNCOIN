...
In order to support loading of multiple wallets in fyn-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is fyn.cpp.
...
Changes to fyn.cpp
----------------------
fyn.cpp is the entry point into fyn-qt, and as such, will require some minor modifications to provide hooks for
