...
This mechanism has been integrated into Bitcore-Node-fyn which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/fynproject/insight-api-fyn#web-socket-api](https://github.com/fynproject/insight-api-fyn#web-socket-api) 
* API: [https://github.com/fynproject/insight-api-fyn#swifttx-transactions](https://github.com/fynproject/insight-api-fyn#swifttx-transactions) 
...
By default, the FYN Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the FYN Core daemon:
