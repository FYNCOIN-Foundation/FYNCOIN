...
public:
    CMainParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // FYN: 1 day
        nTargetSpacing = 1 * 60;  // FYN: 1 minute
        nMaturity = 50;
        ...
        vSeeds.push_back(CDNSSeedData("0", "149.28.19.60")); // run by edward
        vSeeds.push_back(CDNSSeedData("1", "45.32.249.248")); // run by edward
		vSeeds.push_back(CDNSSeedData("2", "167.99.234.230")); // run by cryptodev
        vSeeds.push_back(CDNSSeedData("3", "206.81.15.75")); // run by cryptodev
        ...
        strSporkKey = "0468078ed9e9446615d3f1394da350ff6c389c31c54ffafcf2908130dd6be9026cdcc93c4265b35b521805615afacedf7a75f298f6b9f568a1aad18beb08433469";
        strObfuscationPoolDummyAddress = "Es5bM2cH1wPuiU2zQE8C78EDFQWvDLiVTN";
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // FYN: 1 day
        nTargetSpacing = 1 * 10;  // FYN: 1 minute
        nMaturity = 15;
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet fyn addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet fyn script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet fyn BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet fyn BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet fyn BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // FYN: 1 day
        nTargetSpacing = 1 * 60;        // FYN: 1 minutes
        bnProofOfWorkLimit = ~uint256(0) >> 1;
        genesis.nTime = 1505224800;
        genesis.nBits = 0x207fffff;
        genesis.nNonce = 12345;
