...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* FYN features */
        {"fyn", "masternode", &masternode, true, true, false},
        {"fyn", "listmasternodes", &listmasternodes, true, true, false},
        {"fyn", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"fyn", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"fyn", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"fyn", "getmasternodecount", &getmasternodecount, true, true, false},
        {"fyn", "masternodeconnect", &masternodeconnect, true, true, false},
        {"fyn", "masternodecurrent", &masternodecurrent, true, true, false},
        {"fyn", "masternodedebug", &masternodedebug, true, true, false},
        {"fyn", "startmasternode", &startmasternode, true, true, false},
        {"fyn", "createmasternodekey", &createmasternodekey, true, true, false},
        {"fyn", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"fyn", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"fyn", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"fyn", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"fyn", "getmasternodescores", &getmasternodescores, true, true, false},
        {"fyn", "mnbudget", &mnbudget, true, true, false},
        {"fyn", "preparebudget", &preparebudget, true, true, false},
        {"fyn", "submitbudget", &submitbudget, true, true, false},
        {"fyn", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"fyn", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"fyn", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"fyn", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"fyn", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"fyn", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"fyn", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"fyn", "checkbudgets", &checkbudgets, true, true, false},
        {"fyn", "mnsync", &mnsync, true, true, false},
        {"fyn", "spork", &spork, true, true, false},
        {"fyn", "getpoolinfo", &getpoolinfo, true, true, false},
        {"fyn", "makekeypair", &makekeypair, true, true, false},
#ifdef ENABLE_WALLET
        /* Wallet */
        ...
        {"zerocoin", "getzfynseed", &getzfynseed, false, false, true},
        {"zerocoin", "setzfynseed", &setzfynseed, false, false, true}
...
{
    return "> fyn-cli " + methodname + " " + args + "\n";
}
