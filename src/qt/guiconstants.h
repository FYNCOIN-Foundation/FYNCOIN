...
static const int MAX_PASSFYNASE_SIZE = 1024;

/* FYN GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "FYN"
#define QAPP_ORG_DOMAIN "fyn.org"
#define QAPP_APP_NAME_DEFAULT "FYN-Qt"
#define QAPP_APP_NAME_TESTNET "FYN-Qt-testnet"
