                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzfynPathCustom = GetArg("-zfynbackuppath", "");
    ...
    if(!strzfynPathCustom.empty()) {
        ui->wallet_customzfynbackuppath->setText(QString::fromStdString(strzfynPathCustom));
        ui->wallet_customzfynbackuppath_label->setVisible(true);
        ui->wallet_customzfynbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzfynPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the FYN RPC console.") + "<br>" +
