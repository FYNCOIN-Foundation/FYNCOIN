                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("FYN Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a FYN address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and fyn: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zFYN"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About FYN Core"), this);
    aboutAction->setStatusTip(tr("Show information about FYN Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for FYN"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your FYN addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified FYN addresses"));
    ...
    openAction->setStatusTip(tr("Open a FYN: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the FYN Core help message to get a list with possible FYN command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("FYN Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to FYN network", "", count));
}
...
{
    QString strTitle = tr("FYN Core"); // default title
